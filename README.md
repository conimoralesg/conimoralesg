# Hi, I'm Constanza Morales 🌎

**Geological Civil Engineer | GIS & Remote Sensing Analyst**

I build geospatial analyses of natural hazards — floods, droughts, wildfires,
and landslides — using Python, Google Earth Engine, and QGIS.
...
`Python` `Google Earth Engine` `QGIS` `GeoPandas` `Rasterio` `geemap` `Folium` `HEC-RAS` `Git`
